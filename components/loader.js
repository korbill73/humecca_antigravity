...
const APP_VERSION = 'v.20251226.0156';
...
<header class="header">
    <div class="header-container container">
        ...
        <div class="header-buttons" style="display:flex; align-items:center;">
            ...
            <span style="font-size:10px; color: #ff0000; margin-left:24px; font-weight:bold; position:relative; top:1px;">v.20251226.0156</span>
        </div>
        <!-- Mobile Menu Button -->
