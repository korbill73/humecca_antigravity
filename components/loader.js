...
const APP_VERSION = 'v.20251228.2030';
...
<header class="header">
    <div class="header-container container">
        ...
        <div class="header-buttons" style="display:flex; align-items:center;">
            ...
            <span style="font-size:10px; color: #ff0000; margin-left:24px; font-weight:bold; position:relative; top:1px;">v.20251226.0305</span>
        </div>
        <!-- Mobile Menu Button -->
